...
dbGetQuery(
  ...
  SELECT 
    ...
    AVG("covid_pop") AS "peak_active_cases", 
    AVG("covid_pop") / b.population_size AS "peak_pct_active", 
    AVG("covid_t") AS "t_peak_cases", 
    AVG("cumulative_covid_pop_peak") AS "cumulative_cases",
    AVG("quar_pop") AS "peak_quarantine_census",
    AVG("quar_pop") / b.population_size AS "peak_pct_quarantine",
    AVG("quar_t") AS "t_peak_quarantine"
  INTO metrics
