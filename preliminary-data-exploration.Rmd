...
It seems like the parameters are only varied for groups 0, 1, 2, and 3.  That is, the Undergrads (Dorm = 0, off campus = 1), Grad student research (2), and grad student other(3). 
